...
public interface IMasterMindServer extends Remote
{
	...
	/**
	 * creates a new game on the server. The given client is memorized as the game
	 * initiator and automatically joins the game.
	 * 
	...
	/**
	 * checks the numbers provided by a client against the hidden solution (sequence
	 * of digits)
	 * 
	 * @param aGameID        the identifier of the game.
	...
	/**
	 * deletes a game from the server. must be issued by the creating client if the
	 * game is deleted before its end.
	 * 
	 * @param aGameID         the identifier of the game
	 ...
	 * @return true iff the game was joined successfully, i.e. it is not running and
	 *         MAX_PLAYERS is not exceeded by the join
	 * @throws RemoteException
	 */
